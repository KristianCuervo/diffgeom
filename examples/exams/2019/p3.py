...
covar_A = dg.Field(vector_field=f*A_t, space=space).covariant_derivative(curve=gamma)
...
# 3.5
covar_B = dg.Field(vector_field=h*B_t, space=space).covariant_derivative(curve=gamma)
